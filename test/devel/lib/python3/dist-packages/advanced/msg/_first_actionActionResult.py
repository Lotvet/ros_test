...
"""autogenerated by genpy from advanced/first_actionActionResult.msg. Do not edit."""
import codecs
import sys
...
class first_actionActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "advanced/first_actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','advanced/first_actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(first_actionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = advanced.msg.first_actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = advanced.msg.first_actionResult()
