...
(cl:in-package serverclient-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <addints-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addints-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serverclient-srv:<addints-request> is deprecated: use serverclient-srv:addints-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serverclient-srv:num1-val is deprecated.  Use serverclient-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <addints-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serverclient-srv:num2-val is deprecated.  Use serverclient-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <addints-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'addints-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serverclient-srv:<addints-response> is deprecated: use serverclient-srv:addints-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <addints-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serverclient-srv:sum-val is deprecated.  Use serverclient-srv:sum instead.")
  (sum m))
